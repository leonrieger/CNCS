...
namespace CNCS::ecc {
    ...
    struct Poly {
        ...
        inline void Init(uint8_t id, uint16_t offset, uint8_t size,
                         uint8_t** memory_ptr) {
            this->_id = id;
            this->_offset = offset;
            this->_size = size;
        ...
        inline void Reset() { memset((void*)ptr(), 0, this->_size); }
    ...
    protected:
        ...
        uint8_t** _memory = nullptr; // Pointer to pointer to memory
    };
} // namespace RS
